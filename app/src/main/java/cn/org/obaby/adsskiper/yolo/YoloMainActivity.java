    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSelect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(YoloMainActivity.this);
        ...
        buttonLive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
//                final Intent intent = new Intent(YoloMainActivity.this, ObjectDetectionActivity.class);
//                startActivity(intent);
        ...
        mButtonDetect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Thread thread = new Thread(YoloMainActivity.this);
                thread.start();
            }
        });
...
//        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.beauty, options);
